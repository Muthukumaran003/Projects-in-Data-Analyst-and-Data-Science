...
-- QUERY 27 
-- Show cars whose price is higher than the most expensive car of brand 'Toyota'
SELECT * FROM CAR_PRICE_PREDICTION 
WHERE PRICE =(SELECT MAX(PRICE) AS HIGHEST_PRICE FROM CAR_PRICE_PREDICTION WHERE BRAND = 'TOYOTA');
